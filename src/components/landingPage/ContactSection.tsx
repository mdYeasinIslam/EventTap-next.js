...
const ContactSection = () => {
    return (
        <section className="flex gap-8 p-8 font-sans bg-white rounded-lg border border-dashed border-gray-400 max-w-[1100px] mx-auto my-10 flex-col md:flex-row">
            {/* Left Side */}
            <div className="flex-1 flex flex-col h-full gap-6">
                ...
                {/* Contact Info */}
                <div className=" bg-white rounded-lg border border-gray-200 p-6 flex flex-col gap-6 h-full">
                    {/* Email */}
            ...
            {/* Right Side */}
            <div className="flex-1 bg-white rounded-lg border border-gray-200 p-7 min-w-[350px]">
                <div className="font-fredoka text-4xl md:text-5xl font-bold text-[#3d1a0b] mb-2 leading-tight">
                    Get in Touch
                </div>
                ...
                <form className="flex flex-col gap-4">
                    <label>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 rounded-md border border-gray-400 text-base outline-none mb-2"
                        />
                    </label>
                    <label>
                    ...
                    <label>
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full px-3 py-2 rounded-md border border-gray-400 text-base outline-none resize-vertical mb-2"
                        />
                    </label>
