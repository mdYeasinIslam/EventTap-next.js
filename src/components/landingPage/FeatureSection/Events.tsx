...
const Events = ({ event,visibleItems ,section}: Props
  ...
  return (
      <div key={event.id} className="flex-shrink-0 px-2" style={{ width: `${100 / visibleItems}%` }}>
                        <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 h-full">
                            ...
                            {
                                (section && section ==='events' ) && <p className="text-gray-500 text-sm mb-4">{event.description}</p>
                            }
